                    ...
                    <form method="POST" action="{{ route('users.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="px-4 py-4">
                            ...
                            <div class="mt-4">
                                ...
                                <x-text-input id="expertise" class="block w-full mt-1" type="text" name="expertise" />
                            ...
                            <div class="mt-4">
                                ...
                                <x-text-input id="skill_set" class="block w-full mt-1" type="text" name="skill_set" />
                            ...
                            <div class="mt-4">
                                ...
                                <x-text-input id="academic_level" class="block w-full mt-1" type="text" name="academic_level" />
                            ...
                            <div class="mt-4">
                                ...
                                <x-text-input id="regnum" class="block w-full mt-1" type="text" name="regnum" />
                            ...
                            <div class="mt-4">
                                ...
                                <x-text-input id="programme" class="block w-full mt-1" type="text" name="programme" />
